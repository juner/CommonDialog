...
namespace CommonDialog.Core
{
    ...
    public enum MessageBoxOptions
    {
        ...
        /// station. Specifies that the message box is displayed from a .NET Framework windows
        /// service application in order to notify the user of an event.
        /// </summary>
        ...
        /// a .NET Framework windows service application in order to notify the user of an
        /// event.
        /// </summary>
